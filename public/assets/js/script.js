...
(function($) {
	...
	if(!!hasTemp) {
		$('head').append('<link id="tempSkin" rel="stylesheet" href="public/assets/css/style-'+hasTemp+'.css">')
	...
	$(document).on('click', '.skin-colors a', function(e){
		...
		if(skin === 'default') {
			...
			if($('#tempSkin').length === 0) {
				$('head').append('<link id="tempSkin" rel="stylesheet" href="public/assets/css/style-'+skin+'.css">')
			} else {
